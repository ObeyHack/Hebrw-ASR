QuartzNet3x5_config = [
    ...
    {'filters': 512, 'repeat': 3, 'kernel': 63, 'stride': 1, 'dilation': 1, 'dropout': 0.2, 'residual': True, 'separable': True},

    {'filters': 512, 'repeat': 3, 'kernel': 63, 'stride': 1, 'dilation': 1, 'dropout': 0.2, 'residual': True, 'separable': True},

    {'filters': 512, 'repeat': 3, 'kernel': 75, 'stride': 1, 'dilation': 1, 'dropout': 0.2, 'residual': True, 'separable': True},
